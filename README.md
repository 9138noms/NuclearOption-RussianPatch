...
Мод русской локализации для Nuclear Option. Работает как плагин BepInEx и переводит интерфейс, энциклопедию, подсказки и всплывающие описания — всего **1 427 записей**.
...
| `ru.json` | Данные русского перевода (1 427 записей) |
